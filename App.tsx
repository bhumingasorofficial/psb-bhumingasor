...
const App: React.FC = () => {
    ...
    const FloatingHelp = () => (
        <a 
            ...
            target="_blank"
            rel="noreferrer"
            className="fixed bottom-6 right-6 z-50 flex items-center gap-2 bg-emerald-500 hover:bg-emerald-600 text-white px-4 py-3 rounded-full shadow-lg transition-all hover:-translate-y-1 animate-in fade-in slide-in-from-bottom-10"
        >
    ...
    // --- MAIN FORM MODE ---
    return (
        <div className="min-h-screen bg-slate-50 font-sans flex flex-col items-center py-6 sm:py-12 px-3 sm:px-4">
