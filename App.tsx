...
const App: React.FC = () => {
    ...
    // UX: Floating WhatsApp Help Button (Nomor Umum/Putra)
    const FloatingHelp = () => (
        <a 
    ...
    if (submissionStatus === 'success') {
        return (
            <>
                ...
                <div className="print-only font-serif bg-white p-8 text-black hidden">
                    {/* Kop Surat */}
                    <div className="flex items-center justify-between border-b-2 border-black pb-6 mb-6">
                        <div className="w-24 h-24 flex-shrink-0">
                            <img src={LOGO_URL} alt="Logo" className="w-full h-full object-contain grayscale" />
                        </div>
                        <div className="flex-1 text-center px-4">
                            <h2 className="text-xl font-bold uppercase tracking-wide mb-1">YAYASAN PONDOK PESANTREN</h2>
                            <h1 className="text-2xl font-black uppercase mb-1">AN NUR HIDAYATUS SALAM BHUMI NGASOR</h1>
                            <p className="text-sm italic">
                                Sekretariat: Jl. Pendhopo Kamulyan RT.02 RW.01 Dsn. Bakalan Kec. Bululawang Kab. Malang<br/>
                                Website: https://bhumingasor.com | Email: smpbhumingasor@gmail.com
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="text-center mb-8">
                        <h3 className="text-xl font-bold underline decoration-2 underline-offset-4 mb-2">TANDA BUKTI PENDAFTARAN</h3>
                        <p className="text-sm font-bold uppercase">TAHUN AJARAN 2026/2027</p>
                    </div>

                    {/* ID Card Box */}
                    <div className="border-2 border-black rounded-lg p-6 mb-8 flex justify-between items-center bg-gray-50">
                        <div>
                            <p className="text-xs uppercase font-bold text-gray-600 mb-1">NOMOR REGISTRASI:</p>
                            <p className="text-3xl font-mono font-bold tracking-widest">{registrationId}</p>
                        </div>
                        <div className="text-right">
                             <p className="text-xs uppercase font-bold text-gray-600 mb-1">TANGGAL DAFTAR:</p>
                        ...
                        <table className="w-full text-sm">
                            <tbody>
                                <tr className="border-b border-gray-300">
                                    <td className="py-2 font-bold w-48">JENJANG PENDIDIKAN</td>
                                    <td className="py-2">:</td>
                                    <td className="py-2 uppercase font-bold">{formData.schoolChoice}</td>
                                </tr>
                                <tr className="border-b border-gray-300">
                                ...
                                <tr className="border-b border-gray-300">
                                    ...
                                    <td className="py-2">:</td>
                                    <td className="py-2">{formData.nisn}</td>
                                </tr>
                                <tr className="border-b border-gray-300">
                                    <td className="py-2 font-bold">TEMPAT, TGL LAHIR</td>
                                    <td className="py-2">:</td>
                                    <td className="py-2 uppercase">{formData.birthPlace}, {formData.birthDate}</td>
                                </tr>
                                <tr className="border-b border-gray-300">
                                    <td className="py-2 font-bold">JENIS KELAMIN</td>
                                    <td className="py-2">:</td>
                                    <td className="py-2 uppercase">{formData.gender}</td>
                                </tr>
                                <tr className="border-b border-gray-300">
                                ...
                                <tr className="border-b border-gray-300">
                                    ...
                                    <td className="py-2">:</td>
                                    <td className="py-2 uppercase">{formData.fatherName} / {formData.motherName}</td>
                                </tr>
                                <tr className="border-b border-gray-300">
                                    <td className="py-2 font-bold">NO. WHATSAPP</td>
                                    <td className="py-2">:</td>
                                    <td className="py-2">{formData.parentWaNumber}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    {/* Footer Info */}
                    <div className="bg-gray-100 p-4 border border-black text-xs mb-12">
                    ...
                    <div className="flex justify-between text-center mt-12">
                        <div className="w-64">
                            <p className="mb-20">Panitia PSB,</p>
                            <p className="font-bold border-b border-black inline-block min-w-[150px]">( .................................... )</p>
                        </div>
                        <div className="w-64">
                            <p className="mb-20">Orang Tua / Wali,</p>
                            <p className="font-bold border-b border-black inline-block min-w-[150px]">( {formData.fatherName} )</p>
                        </div>
                    </div>
                </div>
            </>
